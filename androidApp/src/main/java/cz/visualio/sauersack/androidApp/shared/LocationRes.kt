...
sealed class Content: HasText {
    ...
    @Serializable
    data class File(
        val urlIos: String, val urlAndroid: String, override val text: String,
        val sort: Long,
    ) :
        Content()
    ...
    @Serializable
    data class SphereImages(val sphereurl: String, override val text: String, val sort: Long) :
        Content()
}
...
sealed class Container {
    ...
    @Serializable
    @SerialName("sphereImages")
    data class SphereImages(override val content: List<Content.SphereImages>) : Container()
